...
describe('Button', function () {
    ...
    it('Set icon for a button.', function () {
    ...
    it('Enable loading button.', function () {
        var Constructor = _vue2.default.extend(_Button2.default);
        var vm = new Constructor({
            propsData: {
                icon: 'settings',
    ...
    it('Default order of icon is 1', function () {
    ...
    it('Set iconPosition to change order', function () {
        var div = document.createElement('div');
        document.body.appendChild(div);
        var Constructor = _vue2.default.extend(_Button2.default);
        var vm = new Constructor({
    ...
    it('Click button to trigger click event', function () {
        var Constructor = _vue2.default.extend(_Button2.default);
        var vm = new Constructor({
            propsData: {
                icon: 'settings'
