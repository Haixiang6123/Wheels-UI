...
describe('Input', function () {
    ...
    describe('props', function () {
        ...
        it('Receive value parameter', function () {
            vm = new Constructor({
                propsData: {
                    value: '1234'
                }
        ...
        it('Receive disabled parameter', function () {
            vm = new Constructor({
                propsData: {
                    disabled: true
                }
        ...
        it('Receive readonly parameter', function () {
            vm = new Constructor({
                propsData: {
                    readonly: true
                }
        ...
        it('Receive error parameter', function () {
            vm = new Constructor({
                propsData: {
                    error: 'Error'
                }
    ...
    describe('Input event', function () {
        ...
        it('Support change/input/focus/blur event', function () {
            ['change', 'input', 'focus', 'focus'].forEach(function (eventName) {
